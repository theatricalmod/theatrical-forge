...
import dev.theatricalmod.theatrical.blocks.base.BlockIlluminator;
import dev.theatricalmod.theatrical.blocks.cables.BlockCable;
import dev.theatricalmod.theatrical.blocks.dimmable.BlockDimmerRack;
import dev.theatricalmod.theatrical.blocks.dimmable.BlockPlugPanel;
import dev.theatricalmod.theatrical.blocks.interfaces.BlockArtnetInterface;
import dev.theatricalmod.theatrical.blocks.interfaces.BlockDMXInterface;
import dev.theatricalmod.theatrical.blocks.rigging.BlockLadderBar;
import dev.theatricalmod.theatrical.blocks.rigging.bars.BlockBar;
import dev.theatricalmod.theatrical.blocks.rigging.bars.BlockDMXBar;
import dev.theatricalmod.theatrical.blocks.rigging.bars.BlockDMXPowerBar;
import dev.theatricalmod.theatrical.blocks.rigging.bars.BlockSocapexBar;
