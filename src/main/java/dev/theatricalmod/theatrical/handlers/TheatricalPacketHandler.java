...
import dev.theatricalmod.theatrical.packets.SendDMXPacket.ClientHandler;
import dev.theatricalmod.theatrical.packets.UpdateArtNetInterfacePacket;
import dev.theatricalmod.theatrical.packets.UpdateDMXStartAddressPacket;
import dev.theatricalmod.theatrical.packets.UpdateIlluminatorPacket;
import dev.theatricalmod.theatrical.packets.UpdateLightPacket;
import dev.theatricalmod.theatrical.packets.UpdateLightPacket.ServerHandler;
...
public class TheatricalPacketHandler {
    ...
    public static void init() {
        INSTANCE = NetworkRegistry.INSTANCE.newSimpleChannel(
            Reference.MOD_ID);
        INSTANCE
            .registerMessage(ServerHandler.class, UpdateLightPacket.class, 0,
                Side.SERVER);
        INSTANCE
    ...
    public static void clientInit(){
        ...
        INSTANCE
            .registerMessage(UpdateIlluminatorPacket.ClientHandler.class,
                ...
                Side.CLIENT);
        INSTANCE
            .registerMessage(ClientHandler.class, SendDMXPacket.class, 5,
                Side.CLIENT);
        INSTANCE
