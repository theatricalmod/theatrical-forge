...
package dev.theatricalmod.theatrical.blocks.rigging.bars;
...
import dev.theatricalmod.theatrical.tiles.rigging.TileSocapexPipe;
...
public class BlockSocapexBar extends BlockBase implements ISupport, ITileEntityProvider, IHasTileEntity, ITOPProvider {
    ...
    public Class<? extends TileEntity> getTileEntity() {
        return TileSocapexPipe.class;
    }

    @Nullable
    @Override
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileSocapexPipe();
    }
    ...
    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world, IBlockState blockState, IProbeHitData data) {
        ...
        if (tileEntity instanceof TileSocapexPipe) {
            TileSocapexPipe pipe = (TileSocapexPipe) tileEntity;
