...
import dev.theatricalmod.theatrical.tiles.rigging.TileDMXPowerPipe;
...
public class BlockDMXPowerBar extends BlockBase implements ISupport, ITileEntityProvider, IHasTileEntity {
    ...
    public Class<? extends TileEntity> getTileEntity() {
        return TileDMXPowerPipe.class;
    }

    @Nullable
    @Override
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileDMXPowerPipe();
    }
