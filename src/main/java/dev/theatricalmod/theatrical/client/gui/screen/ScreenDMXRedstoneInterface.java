...
public class ScreenDMXRedstoneInterface extends AbstractContainerScreen<ContainerDMXRedstoneInterface> {
    ...
    public ScreenDMXRedstoneInterface(ContainerDMXRedstoneInterface container, Inventory inventory, Component title) {
