...
/**
 * Class stolen from Bagginses, who stole it from TechReborn, who stole it from SteamAgeRevolution, which they stole from BloodMagic,
...
{
    private static final int DELETION_ID = 7071; //MAKE THIS UNIQUE PER MOD THAT USES THIS
