...
public class MovingLightWashFixture extends Fixture {

    public static final ResourceLocation ID = new ResourceLocation(TheatricalMod.MOD_ID, "moving_head_fixture");

    public MovingLightWashFixture() {
        super(ID, FixtureType.INTELLIGENT, HangableType.BRACE_BAR,
            new ResourceLocation(TheatricalMod.MOD_ID, "block/moving_light_wash/moving_head_static"), new ResourceLocation(TheatricalMod.MOD_ID, "block/moving_light_wash/moving_head_bar"),
            new ResourceLocation(TheatricalMod.MOD_ID, "block/moving_light_wash/moving_head_tilt"), new ResourceLocation(TheatricalMod.MOD_ID, "block/moving_light_wash/moving_head_pan"),
            new float[]{0.5F, .6F, .5F}, new float[]{0.5F, .5F, .5F}, new float[]{0F, -0.8F, -0.35F}, 90, 0.5F, 0F, 10, 5,
