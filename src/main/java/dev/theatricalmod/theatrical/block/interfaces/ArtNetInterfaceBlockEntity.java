...
public class ArtNetInterfaceBlockEntity extends TileEntity implements ITickableTileEntity {
    ...
    public ArtNetInterfaceBlockEntity() {
        super(TheatricalBlockEntities.ARTNET_INTERFACE);
