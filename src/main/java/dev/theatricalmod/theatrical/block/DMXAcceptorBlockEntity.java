...
public abstract class DMXAcceptorBlockEntity extends FixtureBlockEntity implements IAcceptsCable {

    private final IDMXReceiver idmxReceiver;

    public DMXAcceptorBlockEntity(TileEntityType<?> tileEntityTypeIn) {
