...
public class CreativeTabs {
    ...
    public static final TheatricalMainTab mainTab = new TheatricalMainTab();
    public static final FixturesTab fixturesTab = new FixturesTab();
    public static final GelsTab gelsTab = new GelsTab();
